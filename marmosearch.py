    ...
    def on_status(self, status):
        ...
        if status.in_reply_to_status_id is None:
          ...
          for word in status.text.split(" "):
            ...
            if results:
              search_params.setdefault(results[0], []).append(word)
          print search_params
          if search_params:
